...
export default function Workspace() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-r from-gray-100 to-gray-300 p-0">
      ...
      {view === "manageEvents" && (
        <div className="w-full bg-white shadow-lg rounded-t-lg">
          <button
            ...
            className="w-full p-4 text-left text-center font-semibold text-lg text-gray-800 bg-gray-200 rounded-t-lg"
          >
            Add Event
          </button>
          <div className="p-4">
            <ul className="list-disc text-center pl-5">
              {events.length > 0 ? (
                events.map((event) => (
      ...
      {/* Add Event */}
      {view === "addEvent" && (
        <div className="w-full text-center bg-white shadow-lg rounded-t-lg">
          <button
            onClick={() => setView("manageEvents")}
            className="w-full p-4 text-center font-semibold text-lg text-gray-800 bg-gray-200 rounded-t-lg"
          >
            Manage Events
          </button>
          <div className="p-4">
